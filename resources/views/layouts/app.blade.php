...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .container {
            /* Ширина контейнера теперь совпадает с шапкой/навбаром:
               те же боковые отступы 32px, без max-width и центрирования,
               чтобы левый край совпадал с началом кнопки "Дашборд",
               а правый — с концом кнопки "Выйти". */
            padding: 32px;
        }
...
<body>
    ...
    @unless(request()->routeIs('dashboard'))
        <div class="navbar">
            ...
            <a href="{{ url('/stock') }}" class="{{ request()->routeIs('stock') ? 'active' : '' }}">Склад</a>
